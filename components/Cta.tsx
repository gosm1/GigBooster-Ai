    ...
    return (
        <section className="bg-black pb-24">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="lg:py-14 lg:px-20 p-10 rounded-2xl bg-gradient-to-r  from-[#804eec] via-[#804eec] to-[#4325FF] flex items-center justify-between flex-col lg:flex-row">
